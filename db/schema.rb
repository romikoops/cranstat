...
ActiveRecord::Schema.define(version: 20171020191418) do
  ...
  create_table "package_authors", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_package_authors_on_user_id"
  end
  ...
  create_table "package_maintainers", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_package_maintainers_on_user_id"
  end
  ...
  add_foreign_key "package_authors", "users"
  add_foreign_key "package_maintainers", "packages"
  add_foreign_key "package_maintainers", "users"
end
